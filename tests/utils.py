...
def create_users(ds, count=None):
    users = [('matt@lp.com', 'matt', 'password', ['admin'],
              True, None, None),
             ('joe@lp.com', 'joe', 'password', ['editor'],
              True, None, None),
             ('dave@lp.com', 'dave', 'password', ['admin', 'editor'],
              True, None, None),
             ('jill@lp.com', 'jill', 'password', ['author'],
              True, None, None),
             ('tiya@lp.com', 'tiya', 'password', [],
              False, None, None),
             ('jess@lp.com', 'jess', None, [],
              True, None, None),
             ('gal@lp.com', 'gal', 'password', ['admin'],
              True, 'sms', u'RCTE75AP2GWLZIFR'),
             ('gal2@lp.com', 'gal2', 'password', ['admin'],
              True, 'google_authenticator',
              u'RCTE75AP2GWLZIFR'),
             ('gal3@lp.com', 'gal3', 'password', ['admin'],
              True, 'mail', u'RCTE75AP2GWLZIFR')]
